...
"""plot the graph"""
fig = px.scatter(df,x='3 Points Shots Attempted Per Match', y='3 Points Shots Scored Per Match', hover_name='PLAYER',title="3 Points",template="plotly_white",color='best_worst')
